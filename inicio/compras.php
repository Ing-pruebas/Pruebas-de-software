...
$sel_compras = $con->prepare("SELECT * FROM compras WHERE correo_usuario = ? AND estatus_compra = 'COMPRADO' ORDER BY fecha DESC ");
...
<div class="container" style="margin-top: 1%;">
	...
	<div class="card w-100">
			<div class="card-body">
				<div class="row">
					<div class="col-4">
						<img src="../ecommerce/admin/<?php echo $f_compras['foto'] ?>" width="100%">
					</div>
					<div class="col-8">
