        ...
        <div class="card-body">
          <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6">
             ...
             <div required="true" class="col-sm-12 col-md-6 col-lg-6">
                ...
                <div class="form-group">
                  <input required="true" type="number" id="cantidad" class="form-control" placeholder="Cantidad"  max="<?php echo $f['cantidad'] ?>" >
                </div>
                <button required id="agregar_carrito" class="btn btn-primary" >Agregar al carrito</button>
